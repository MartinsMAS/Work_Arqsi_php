...
function loadLivrosEditoras() {
    ...
    var nB = document.getElementById("nLivrosEditora").value;
    MakeXMLHTTPCallNLivros(nB);
}
...
function createEditora() {
    ...
    td2.setAttribute("id", "showNResultsPageTd");
    td2.setAttribute("class", "showNResultsPageTd");
...
function creteMiddleSection(xml) {
    try {
        var nP = document.getElementById("showNResultsPage").value;
    } catch (e) {
        var x = document.getElementById("comboShowNResults").selectedIndex;
        var y = document.getElementById("comboShowNResults").options;
        var nPtxt = y[x].text;
...
function preencheDivPopUp(xml) {
    ...
    td1.setAttribute("id", "titulo");
    td2.setAttribute("width", "180");
    td2.setAttribute("class", "autor");
    td2.setAttribute("id", "autor");
    td3.setAttribute("width", "200");
    td3.setAttribute("class", "imagem");
    td3.setAttribute("id", "imagem");
    td3.setAttribute("rowspan", "4");
    td4.setAttribute("class", "categoria");
    td4.setAttribute("id", "categoria");
    td5.setAttribute("class", "isbn");
    td5.setAttribute("id", "isbn");
    td6.setAttribute("colspan", "2");
    td6.setAttribute("class", "textoRolante");
    td6.setAttribute("id", "textoRolante");
    td7.setAttribute("colspan", "2");
    td7.setAttribute("class", "sinopse");
    td7.setAttribute("id", "sinopse");
    td8.setAttribute("colspan", "2");
    td8.setAttribute("class", "impressora");
    td8.setAttribute("id", "impressora");
